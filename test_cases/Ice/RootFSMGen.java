...
public void cancel() {handleEvent(Event.cancel);}
public void init() {handleEvent(Event.init);}
public void auto() {handleEvent(Event.auto);}
public void nextBatchFound() {handleEvent(Event.nextBatchFound);}
public void select() {handleEvent(Event.select);}
public void refresh() {handleEvent(Event.refresh);}
public void login() {handleEvent(Event.login);}
public void manual() {handleEvent(Event.manual);}
public void requeue() {handleEvent(Event.requeue);}
public void openPage() {handleEvent(Event.openPage);}
public void exit() {handleEvent(Event.exit);}
public void goBack() {handleEvent(Event.goBack);}
public void stop() {handleEvent(Event.stop);}
public void reject() {handleEvent(Event.reject);}
public void batchesFound() {handleEvent(Event.batchesFound);}
public void itemChanged() {handleEvent(Event.itemChanged);}
public void redisplay() {handleEvent(Event.redisplay);}
public void noBatchFound() {handleEvent(Event.noBatchFound);}
public void ok() {handleEvent(Event.ok);}
public void complete() {handleEvent(Event.complete);}
public void setZone() {handleEvent(Event.setZone);}
public void assign() {handleEvent(Event.assign);}
