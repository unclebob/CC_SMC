...
public class NSCGeneratorTest {
  ...
  public class SwitchCaseTests {
    ...
    public void OneTransition() throws Exception {
      assertGenerated("{I e I a}", "s state {case I {s event {case e {setState(State.I) a() }}}}");
    }
    ...
    public void twoTransitions() throws Exception {
      assertGenerated("{I e1 S a1 S e2 I a2}",
        "" +
          ...
          "case S {s event {case e2 {setState(State.I) a2() }}}" +
          "}");
    }
    ...
    public void twoStatesTwoEventsFourActions() throws Exception {
      assertGenerated(
        ...
        "" +
          "s state {" +
          "case I {s event {case e1 {setState(State.S) a1() }case e2 {setState(State.I) a2() }}}" +
          "case S {s event {case e1 {setState(State.I) a3() }case e2 {setState(State.S) a4() }}}}");
    }
  } // SwitchCase Tests.
